...
if ( ! function_exists( 'gutentype_trx_addons_add_theme_vars' ) ) {
	add_filter( 'gutentype_filter_add_theme_vars', 'gutentype_trx_addons_add_theme_vars', 10, 2 );
	function gutentype_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'gutentype_trx_addons_get_css' ) ) {
	add_filter( 'gutentype_filter_get_css', 'gutentype_trx_addons_get_css', 10, 2 );
	function gutentype_trx_addons_get_css( $css, $args ) {
...
.post_item_single .sc_widget_recent_posts .widget_recent_posts .post_item .post_title a {
    {$fonts['button_font-weight']}
}
...
.sidebar_inner .sc_blogger_item_title a:hover {
	color: {$colors['text_link']};
}
.sc_blogger_post_meta {
	color: {$colors['alter_light']};
...
.slider_style_modern .post_meta_item.post_categories a:hover {
	color: {$colors['text_hover']};
}
...
.sc_recent_news.sc_recent_news_style_news-extra .post_item .post_info .post_categories {
	background-color: {$colors['text_link']} !important;
}
.sc_recent_news.sc_recent_news_style_news-extra .post_item .post_info .post_categories a {
	color: {$colors['inverse_link']};
}
