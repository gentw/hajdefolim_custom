...
Please install and activate it before starting to use the theme GutenType.
...
Theme documentation is available on http://gutentype.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in GutenType is Fontello.
