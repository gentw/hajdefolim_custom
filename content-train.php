<?php
/**
 * The Train template to display the content
 *
...
<article id="post-<?php the_ID(); ?>"
	<?php post_class( 'post_item post_layout_train post_format_' . esc_attr( $gutentype_post_format ) ); ?>
            ...
            if ( gutentype_get_theme_option( 'blog_content' ) == 'fullpost' ) {
                ...
                ?>
                    ...
                    if ( empty( $gutentype_template_args['no_links'] ) && ! in_array( $gutentype_post_format, array( 'link', 'aside', 'status', 'quote' ) ) ) {
                        ?>
                        <a class="train-more-link" href="<?php echo esc_url( get_permalink() ); ?>"><?php esc_html_e( 'Read Article', 'gutentype' ); ?></a>
                        <?php
                    }
            }
            ?>
