...
if ( ! function_exists( 'gutentype_customizer_get_css' ) ) {

	function gutentype_customizer_get_css( $args = array() ) {
		...
		if ( $fonts ) {
			...
			$fonts = gutentype_customizer_add_theme_fonts( $fonts );
...
CSS;
			$rez          = apply_filters( 'gutentype_filter_get_css', $rez, array( 'fonts' => $fonts ) );
			$css['fonts'] = $rez['fonts'];
		}
		...
		if ( $vars ) {
			...
			// Make theme-specific fonts rules
			$vars = gutentype_customizer_add_theme_vars( $vars );
			extract( $vars );
...
CSS;
			$rez          = apply_filters( 'gutentype_filter_get_css', $rez, array( 'vars' => $vars ) );
			$css['vars']  = $rez['vars'];
		}
		...
		//--------------------------------------
		if ( false !== $colors ) {
			$schemes = empty( $scheme ) ? array_keys( gutentype_get_sorted_schemes() ) : array( $scheme );
			...
			if ( count( $schemes ) > 0 ) {
				...
				foreach ( $schemes as $s ) {
					// Prepare colors
					if ( empty( $scheme ) ) {
						$colors = gutentype_get_scheme_colors( $s );
					}

					// Make theme-specific colors and tints
					$colors = gutentype_customizer_add_theme_colors( $colors );
...
blockquote.wp-block-quote:not(.is-style-large) a {
	color: {$colors['text_link']};
}
blockquote.wp-block-quote:not(.is-style-large) a:hover {
	color: {$colors['text_hover']};
}
blockquote.wp-block-quote:not(.is-style-large) dt, blockquote.wp-block-quote:not(.is-style-large) b, 
blockquote.wp-block-quote:not(.is-style-large) strong, blockquote.wp-block-quote:not(.is-style-large) i, 
blockquote.wp-block-quote:not(.is-style-large) em, blockquote.wp-block-quote:not(.is-style-large) mark, 
blockquote.wp-block-quote:not(.is-style-large) ins {	
	color: {$colors['text']};
}
blockquote.wp-block-quote:not(.is-style-large) s, blockquote.wp-block-quote:not(.is-style-large) strike,
 blockquote.wp-block-quote:not(.is-style-large) del {	
	color: {$colors['text']};
}
blockquote.wp-block-quote:not(.is-style-large) code {
	color: {$colors['extra_dark']};
	background-color: {$colors['extra_bg_hover']};
	border-color: {$colors['extra_bd_hover']};
}
...
.wp-caption-overlay .wp-caption .wp-caption-dd {
	color: {$colors['inverse_link']};
	background-color: {$colors['inverse_dark_08']};
}
ul > li:before {
	color: {$colors['text_link']};
}
...
/* Normal button */
.go_home,
.wp-block-button:not(.is-style-outline) .wp-block-button__link:not(.has-text-color):not(.has-text-color):not(.has-background),button:not(.components-button):not(.components-tab-button ),
input[type="reset"],
input[type="submit"],
input[type="button"],
.post_item .more-link,
...
.nav-links-more a {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
	box-shadow: 0px 20px 18px -22px {$colors['text_link']};
}

.wp-block-button.is-style-outline .wp-block-button__link:not(.has-text-color):not(.has-text-color) {
	border-color: {$colors['input_bd_hover']};
}
.wp-block-button.is-style-outline .wp-block-button__link:not(.has-text-color):not(.has-text-color):hover {
	border-color: {$colors['text_link']};
}
...
.wpcf7 .wpcf7-submit {
	box-shadow: 0px 20px 18px -22px {$colors['text_link2']};
...
.search-no-results .search_wrap .search_submit:hover:before {
	color: {$colors['extra_dark']};
}
...
button:not(.components-button):not(.components-tab-button ):hover,
button:not(.components-button):not(.components-tab-button ):focus,
...
.comments_wrap .form-submit input[type="submit"]:active,
.comments_wrap .form-submit input[type="submit"]:focus,
.comments_wrap .form-submit input[type="submit"]:hover,
...
.scheme_self.footer_default.center_style .footer_copyright_wrap .content_wrap,
.scheme_self.footer_default.modern_style .footer_copyright_wrap .content_wrap {
	border-color: {$colors['bd_color']};
}
...
.top_panel_center .top_panel_navi,
.scheme_self.top_panel_center .top_panel_navi {
	background-color: {$colors['bg_color']};
}
...
.sc_layouts_row_type_compact .search_wrap .search_submit:hover:before,
.scheme_self.sc_layouts_row_type_compact .search_wrap .search_submit:hover:before {
	color: {$colors['text_hover']};
}
...
.elementor-element .sc_recent_news .post_item .post_footer .post_counters .post_counters_item.trx_addons_icon-eye > .post_counters_number,
.elementor-element .sc_recent_news .post_item .post_footer .post_counters .post_counters_item.trx_addons_icon-eye > .post_counters_label,
.elementor-element .sc_recent_news .post_item .post_footer .post_counters .post_counters_item.trx_addons_icon-eye:before {
...
/* Custom menu */
.custom_main_nav.sc_layouts_menu_nav > li > a {
	color: {$colors['text_dark']} !important;
}
.custom_main_nav.sc_layouts_menu_nav > li:before {
	color: {$colors['text_dark']} !important;
}
.custom_main_nav.sc_layouts_menu_nav > li > a:hover,
.custom_main_nav.sc_layouts_menu_nav > li.sfHover > a {
	color: {$colors['text_link']} !important;
}

.custom_main_nav.sc_layouts_menu_nav > li:hover:before {
	color: {$colors['text_link']} !important;
}
.custom_main_nav.sc_layouts_menu_nav > li.sfHover:before {
	color: {$colors['text_link']} !important;
}
.custom_main_nav.sc_layouts_menu_nav > li.current-menu-item:before,
.custom_main_nav.sc_layouts_menu_nav > li.current-menu-parent:before,
.custom_main_nav.sc_layouts_menu_nav > li.current-menu-ancestor:before,
.custom_main_nav.sc_layouts_menu_nav > li.current-menu-item > a,
.custom_main_nav.sc_layouts_menu_nav > li.current-menu-parent > a,
.custom_main_nav.sc_layouts_menu_nav > li.current-menu-ancestor > a {
	color: {$colors['text_link']} !important;
}
...
body.scheme_extra .search_style_fullscreen.search_opened .search_form_wrap,
body.scheme_extra .menu_mobile_inner {
	background-color: {$colors['alter_bg_color']};
}
...
.sc_layouts_item .sc_layouts_cart_icon:hover {
	color: {$colors['text_link']};
}
...
.header_position_over header.scheme_self .top_panel .top_panel_navi:not(.sc_layouts_row_fixed_on) {
...
.gutentype_tabs .gutentype_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.gutentype_tabs .gutentype_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.sheme_self.sidebar .gutentype_tabs .gutentype_tabs_titles li a {
	color: {$colors['alter_dark']};
	background-color: {$colors['alter_bg_hover']};
}
.sheme_self.sidebar div.esg-filter-wrapper .esg-filterbutton > span:hover,
.sheme_self.sidebar .mptt-navigation-tabs li a:hover,
.sheme_self.sidebar .gutentype_tabs .gutentype_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_link']};
}
...
.sheme_self.sidebar .gutentype_tabs .gutentype_tabs_titles li.ui-state-active a {
...
.sidebar_elementor .sc_recent_news .post_item.post_layout_news-announce .post_featured .post_info .post_categories a,
.sidebar .sc_recent_news .post_item.post_layout_news-announce .post_featured .post_info .post_categories a {
	color: {$colors['inverse_link']};
}
.sidebar_elementor .sc_recent_news .post_item.post_layout_news-announce .post_featured .post_info .post_categories a:hover,
.sidebar .sc_recent_news .post_item.post_layout_news-announce .post_featured .post_info .post_categories a:hover {
	color: {$colors['inverse_dark']};
}
...
/* Single post */
.related_wrap .related_item_style_2 .post_date:hover,
...
.sc_layouts_meta .post_meta_item .social_item:hover,
.post_item_single .post_meta_item:not(.post_counters_views):hover,
.post_item_single .post_header .post_meta .vc_inline-link:hover,
.post_item_single .post_meta_item > a:hover,
.post_item_single .post_meta_item .socials_caption:hover,
.post_item_single .post_edit a:hover,
.elementor-element .socials_share.socials_type_drop .social_item>.social_icon:hover>span:before {
	color: {$colors['text_hover']};
}
/* Elementor Recent News Widget */
.elementor-element .sc_recent_news .post_item .post_footer .post_counters .post_counters_item:hover {
	color: {$colors['text_hover']} !important;
}
.elementor-element .sc_recent_news .post_item .post_title a:hover {
	color: {$colors['text_link']} !important;
}
...
.scheme_self.sidebar .widget_popular_posts .post_item .post_title a:hover {
	color: {$colors['text_link']};
}
...
.scheme_self.footer_wrap.footer_plain {
	background-color: {$colors['alter_bg_color']};
}
...
.scheme_self.footer_default .footer_copyright_wrap .content_wrap:before,
...
.header_type_woo .footer_default .footer_copyright_wrap .content_wrap:before,
.blog_style_simple .footer_default .footer_copyright_wrap .content_wrap:before {
	background-color: {$colors['alter_bg_color']};
	color: {$colors['text']};
}
.header_type_woo .footer_copyright_inner .copyright_text,
.blog_style_simple .footer_copyright_inner .copyright_text {
	color: {$colors['text']};
}
...
.footer_default.center_style .footer_copyright_inner .copyright_text,
.scheme_self.footer_default.center_style .footer_copyright_inner .copyright_text,
.footer_default.modern_style .footer_copyright_inner .copyright_text,
.scheme_self.footer_default.modern_style .footer_copyright_inner .copyright_text {
	color: {$colors['text_dark']};
}
...
.scheme_self.footer_plain .footer_copyright_wrap .content_wrap {
	background-color: {$colors['bg_color']};
}
...
.socials_wrap.side .social_item:hover {
	background-color: {$colors['text_hover']};
}
...
.cc-link:hover, .cc-link:active, .cc-link:visited,
...
.post_layout_train .train-more-link:hover,
.post_layout_split .simple-more-link:hover,
.post_layout_simple .simple-more-link:hover {
	color: {$colors['text_link']};
	border-color: {$colors['text_link']};
}
...
.slider_style_default .slider-slide .post_categories a {
	color: {$colors['inverse_link']};
}
.sc_recent_news .post_item .post_featured .post_info .post_categories,
.slider_style_default .slider-slide .post_categories,
.elementor-element .slider_style_default .slider-slide .post_categories,
 .elementor-element .slider_style_default .slider-slide .post_categories:hover {
	background-color: {$colors['text_link2']};
	color: {$colors['inverse_link']};
}

.sc_recent_news.sc_recent_news_style_news-portfolio .trx_addons_columns_wrap .post_item .post_featured:hover .post_info .post_categories {
	background-color: {$colors['text_link']};
}
...
.footer_default.center_style .footer_socials_inner .social_item .social_icon,
.scheme_self.footer_default.center_style .footer_socials_inner .social_item .social_icon {
	background-color: {$colors['text_dark_005']};
}
...
.post_layout_train.one .post_featured .post_title a,
.post_layout_train.one .post_featured .post_title a * {
	color: {$colors['inverse_link']};
}
...
.post_layout_train.one .post_info .post_categories  a {
	color: {$colors['inverse_link']};
}
...
CSS;
					...
					$rez            = apply_filters(
						'gutentype_filter_get_css', $rez, array(
							'colors' => $colors,
							'scheme' => $s,
						)
					);
		...
		return apply_filters( 'gutentype_filter_prepare_css', $css_str, $remove_spaces );
	}
}
